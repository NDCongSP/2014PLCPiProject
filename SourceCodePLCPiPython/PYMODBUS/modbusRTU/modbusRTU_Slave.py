...
context = ModbusServerContext(slaves  = {0x01: c1} , single=False)
...
StartSerialServer(context, identity=identity, port='/dev/ttyUSB0',stopbits=1, bytesize=8, parity='N',baudrate=9600, timeout=1)
