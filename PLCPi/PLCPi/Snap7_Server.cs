...
namespace PLCPiProject
{
    ...
    public class Snap7_Server
    {
        S7Server Server;
        /// <summary>
        /// S7 Server có 6 byte ngõ ra QB
        /// </summary>
        public Ngo_Ra NgoRa;

        /// <summary>
        /// S7 Server có 5 byte ngõ vào IB
        /// </summary>
        ...
        public string Khoitao()
        {
            try
            {
                ...
                Server.RegisterArea(S7Server.srvAreaPE, 0, ref NgoVao.MangNgoVao, NgoVao.MangNgoVao.Length); //ngo vao
                Server.RegisterArea(S7Server.srvAreaPA, 0, ref NgoRa.MangNgoRa, NgoRa.MangNgoRa.Length);//ngo ra
