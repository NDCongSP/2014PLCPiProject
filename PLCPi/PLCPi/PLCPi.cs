...
namespace PLCPiProject
{
    ...
    public class PLCPi: Component, IDisposable
    {
        #region Ngõ ra
        /// <summary>
        /// Đối tượng tương tác ngõ ra DO của PLCPi
        /// </summary>
        public Ngo_Ra NgoRa
        {           
            get { return _NgoRa; }
        ...
        static Ngo_Ra _NgoRa = new Ngo_Ra();
        #endregion

        #region Ngõ vào
        /// <summary>
        /// Đối tượng tương tác ngõ vào DI của PLCPi
        /// </summary>
        ...
        static Ngo_Vao _NgoVao = new Ngo_Vao();
        #endregion
        ...
        #region Hiển thị module hiển thị led 7 đoạn
        /// <summary>
        /// Đối tượng tương tác với module Display LED 7 đoạn
        /// </summary>
        public Hien_Thi HienThiLed
        {
            get { return _HienThiLed7; }
        }
        static Hien_Thi _HienThiLed7 = new Hien_Thi();
        #endregion
        ...
        public PLCPi() 
        {
            S7Ethernet.Server.NgoVao = NgoVao;
            S7Ethernet.Server.NgoRa = NgoRa;
        }
        #endregion
